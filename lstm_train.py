...
def main():
    ...
    parser.add_argument('--dataset', default='VAFeatureABAW5', help='Dataset name')
    ...
    if args.dataset == 'VAFeatureABAW5':
        train_annotation_path = args.datadir + 'annotations/VA/Train_Set/'
        ...
        trainset = SequenceFeatureABAW5(train_annotation_path, image_path, abaw5_feature1, abaw5_feature2, args.length, 'train')
    ...
    if args.arc == 'lstm':
        ...
        net = Transformer(1288, 2, 512, args.head, 512, 0.1, args.layer)
